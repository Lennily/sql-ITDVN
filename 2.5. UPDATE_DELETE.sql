...
-- вставить строку в таблицу MyFriends
INSERT MyFriends
(FstName, Ntel)
VALUES ('Max', '050*******');
GO
...
-- Возможно изменить значение сразу в нескольких столбцах
UPDATE MyFriends
...
UPDATE MyFriends
SET Ntel = '060*******' -- Если не задана конструкция WHERE, то меняется весь столбец на указанное значение
GO
...
-- т.к. TRUNCATE удаляет информацию из базы быстрее, чем стандартный DELETE.
